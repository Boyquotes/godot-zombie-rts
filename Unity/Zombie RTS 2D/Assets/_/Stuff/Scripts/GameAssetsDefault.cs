...
public class GameAssetsDefault : MonoBehaviour {

    private static GameAssetsDefault _i;

    public static GameAssetsDefault i {
        get {
            if (_i == null) _i = Instantiate(Resources.Load<GameAssetsDefault>("GameAssetsDefault"));
            return _i;
        }
    }
